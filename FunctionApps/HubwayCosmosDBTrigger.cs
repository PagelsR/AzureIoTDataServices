            ...
            if (input != null && input.Count > 0)
            {
                ...
                foreach (var tripData in input)
                {
                    ...
                    try
                    {
                        ...
                        var url = $"https://atlas.microsoft.com/search/address/reverse/json?subscription-key={QESGI-AhWuyauk_mZXoSr_5J_6Xf_10NYehH4NxHAWY}&api-version=1.0&query={lat},{lon}";
